...
You should now be on the admin dashboard. The right menu, aka _"XP admin menu"_, is responsible to allow navigation through some of the installed apps on your XP instance. By now you should only have two apps installed:

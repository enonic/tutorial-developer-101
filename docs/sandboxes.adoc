...
NOTE: THe background picture gets updated with new versions of XP
...
NOTE: XP localizes the admin interface automatically based on your browsers preferred language, so things may be translated to another language based you your setup.
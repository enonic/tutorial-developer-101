...
:see-prev-docs: The tasks and examples in this {document} are based on work done in previous {document}s (starting with <<sandbox#, the sandboxes chapter>>). If you want to follow along with the examples, make sure you're all caught up.
...
:title-x-data: X-data
:title-headless-api: GraphQL API
...
:description-sandbox: Introducing a fundamental concept of Enonic XP development: sandboxes.

...
:description-media: How does XP deal with images and other media? This {document} covers XP media support, how to upload and query for media, and how to work with images.
...
:description-advanced-content: X-data is a way for you to add extra data to all your content types in a simple manner. This {document} covers what it is and how to use it.

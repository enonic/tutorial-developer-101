...
TIP: If you've already got those configured and installed, feel free to skip to the next {document}.
...
Congrats! You've installed the Enonic CLI, Git, and an editor. You're now set up to start working with Enonic XP 🚀

...
The purpose of this {document} is to ensure you have the necessary tools to be able to start developing efficiently with XP, and if that's not the case, guide you to setup your local environment for that purpose. 

In general, the bare minimum you'll need are:

...
image::input-type-html-area-all-controls.png[HtmlArea: A rich text input field with visible formatting options., width=600]
...
image::input-type-html-area-no-controls.png[HtmlArea: A rich text input field with visible formatting options., width=600]
...
image::input-type-html-area-some-controls.png[HtmlArea: A rich text input field with visible formatting options., width=600]



Show three different configurations: empty (`exclude *`), full (`include *`), and somewhere in between (`exclude *, include [ a b c ]`)

...
To find the url of the API, you can navigate to http://localhost:8080/site/default/draft/colors/api.  The url is weird, but okay `<host>:<port>/site/<project>/<branch>/<site>/api`.

If you haven't used GraphQL before, you'll be just fine.

...
NOTE: This {document} builds on the system we set up in the previous few {document}s, so if you haven't already done it, make sure you go through it and get everything ready. When you're sure you're up to speed with the previous {document}, let's get get started!
...
image::content-studio-content-status.png[Three pieces of content displaying the three statuses that a piece of content can have, width=400]
...
To publish a piece of content, you can either right click it or use the shortcut kbd:[ctrl+Alt+P]/kbd:[⌘+Alt+P].
...
image::content-studio-publishing-wizard.png[A dialog with a list of the content to be published and button saying 'publish now']

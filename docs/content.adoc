...
.Image with exact width
image::content-type-target.png["A content creation form with name and biography fields", width=2751]

.Image without width
image::content-type-target.png["A content creation form with name and biography fields"]

...
Now we're finally ready to create some actual content! With your sandbox up and running, navigate to {cs-url}[Content Studio]. You should be met with an empty studio that tells you are "wasting this space":

...
After you've added an image (or several), you can highlight it and click the edit button. This will take you to the image editing form. This is the same form as we saw in xref:media#_editing_images[the previous {document}].
...
Now create some links using ContentSelector from {content-type-1}s to {content-type-2}s.

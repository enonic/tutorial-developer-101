...
Doc link: https://developer.enonic.com/docs/xp/stable/cms/input-types#textline
...
Doc link: https://developer.enonic.com/docs/xp/stable/cms/input-types#htmlarea

If you want an input field for longer text or text with formatting, HtmlArea is probably what you're looking for. It gives you a multi-line input field with rich formatting options, much like what you're used to from your favorite word processor.

You can also configure what sort of formatting tools to provide using the `exclude` and `include` config options, and which heading levels are allowed.

...
+
https://developer.enonic.com/docs/xp/stable/cms/schemas/input-types/htmlarea[HtmlArea]:: Provides a rich text, multi-line input. We'll discuss this in detail in <<rich-text#,the next {document}>>.
+

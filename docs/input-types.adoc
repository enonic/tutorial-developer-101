...
Some other very useful input types that it's worth taking a look into are:
...
Enonic also provides XML Schema Definitions (XSDs) for text editor integration and validation of your XML schemas. To use it, add the attribute `xmlns="urn:enonic:xp:model:1.0"` to your content-type as show below:

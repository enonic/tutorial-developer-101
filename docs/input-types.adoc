...
image::input-type-image-selector-highlighted-image.png["The image selector input field with two images of lions -- one male, one female - - below. Under the images, there's a set of buttons saying 'edit' and 'remove'.", width=800]
...
image::image-editing-focal-point.png[An image with a focal point around the key part of the image,width=800]

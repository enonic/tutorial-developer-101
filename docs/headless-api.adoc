...
We'll now introduce and show examples of usaged of three different fields underneath `guillotine` field, that allow us to search the system for specific data.

...
image::applications-vanilla.png[The applications list with a single application installed. Also application details, such as content install time, version, and required XP system version.]

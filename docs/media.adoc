  ...
  "data": {
    "guillotine": {
      "getChildren": [
        {
          "displayName": "lion",
          "imageUrl": "http://localhost:8080/site/default/draft/my-first-site/_/image/01ecdce7-01b7-43cb-a5e3-d0ef64a4356e:d7939cce949cd3832c987820caa361c4aec72598/block-750-600/image-to-upload-copy.jpg?filter=flipv%28%29%3B+grayscale%28%29"
        }
      ]
    }
  }

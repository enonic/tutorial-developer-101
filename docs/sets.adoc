...
image::sets-option-set-wrap-item-set.png["An item set wrapping an option set. The option set has nested item sets within. Showing data about P!nk.",{image-xl}]

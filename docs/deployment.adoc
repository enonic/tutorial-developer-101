...
To make sure it all worked, click on the red "launch" button on your Cloud console Dashboard, then access the "Applications" app, and check if "My first app" is listed on the installed applications list.
...
WARNING: Before proceeding, access Content Studio on your cloud instance and make sure to create a project there assigning our app "My first app" to it. This is needed because the cloud instance is a new empty environment.
...
TIP: For more information on Enonic Cloud, visit https://enonic.com/platform/cloud-service[the Enonic Cloud marketing page].

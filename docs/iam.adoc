...
The XP IAM system has three principles: _users_, _groups_, and _roles_.

A _user_ is ...

A _group_, as the name implies is a group of users. This is ...

A _role_ ...

Q: Can roles do anything that groups cannot?:: A: 🤷

== Permissions

What are permissions? You can give permissions to roles, to groups, and to individual users. But why?

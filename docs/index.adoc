...
Hi👋, and welcome to this in-depth guide to get familiar with Enonic. The guide is aimed at people new to Enonic, covering everything you need to know for a flying start.
...
If you have any questions or find any errors (or have any other feedback), don't hesitate to  https://github.com/enonic/doc-developer-101/[create an issue over at GitHub^] 📣
